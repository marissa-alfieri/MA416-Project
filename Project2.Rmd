...
We fitted the logistic regression model using base R's `glm()` function with a binomial family and logit link. The model estimates how each predictor affects the log-odds of having high life expectancy.
